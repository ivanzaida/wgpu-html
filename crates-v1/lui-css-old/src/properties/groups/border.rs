...
impl PropertyGroup for BorderGroup {
  fn apply(&self, declarations: &DeclarationBlock, style: &mut Style) {
    for decl in &declarations.declarations {
      ...
      match p {
        "border" => parse_border_shorthand(v, style),
        "border-top" => parse_border_side_shorthand(v, style, Side::Top),
        "border-right" => parse_border_side_shorthand(v, style, Side::Right),
        "border-bottom" => parse_border_side_shorthand(v, style, Side::Bottom),
        "border-left" => parse_border_side_shorthand(v, style, Side::Left),
        "border-width" => apply_border_widths(v, style),
        "border-style" => apply_border_styles(v, style),
        "border-color" => apply_border_colors(v, style),
        "border-top-width" => style.border_top_width = parse_css_length(v),
        "border-right-width" => style.border_right_width = parse_css_length(v),
        "border-bottom-width" => style.border_bottom_width = parse_css_length(v),
        "border-left-width" => style.border_left_width = parse_css_length(v),
        "border-top-style" => style.border_top_style = warn_none(p, v, parse_border_style(v)),
        "border-right-style" => style.border_right_style = warn_none(p, v, parse_border_style(v)),
        "border-bottom-style" => style.border_bottom_style = warn_none(p, v, parse_border_style(v)),
        "border-left-style" => style.border_left_style = warn_none(p, v, parse_border_style(v)),
        "border-top-color" => style.border_top_color = parse_css_color(v),
        "border-right-color" => style.border_right_color = parse_css_color(v),
        "border-bottom-color" => style.border_bottom_color = parse_css_color(v),
        "border-left-color" => style.border_left_color = parse_css_color(v),
        "border-radius" => apply_border_radii(v, style),
