...
use crate::{BackgroundImagePaint, ImageCache, Rect, gradient};
...
fn compute_bg_tiles(bg: Rect, tile_w: f32, tile_h: f32, off_x: f32, off_y: f32, repeat: BackgroundRepeat) -> Vec<Rect> {
