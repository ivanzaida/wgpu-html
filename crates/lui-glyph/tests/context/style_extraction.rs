...
fn extracts_font_size_px() {
    let val = CssValue::Dimension { value: 24.0, unit: CssUnit::Px };
    let style = ComputedStyle { font_size: Some(&val), ..ComputedStyle::default() };
...
fn extracts_line_height_px() {
    let lh = CssValue::Dimension { value: 28.0, unit: CssUnit::Px };
    let style = ComputedStyle { line_height: Some(&lh), ..ComputedStyle::default() };
    let ts = text_style_from_cascade(&style);
...
fn extracts_line_height_as_factor_of_font_size() {
    let fs = CssValue::Dimension { value: 20.0, unit: CssUnit::Px };
...
fn defaults_line_height_to_1_2_factor_of_font_size() {
    let fs = CssValue::Dimension { value: 20.0, unit: CssUnit::Px };
    let style = ComputedStyle { font_size: Some(&fs), ..ComputedStyle::default() };
    let ts = text_style_from_cascade(&style);
...
fn extracts_font_weight_number() {
    ...
    let style = ComputedStyle { font_weight: Some(&w), ..ComputedStyle::default() };
    let ts = text_style_from_cascade(&style);
...
fn extracts_font_family_from_string_value() {
    ...
    let style = ComputedStyle { font_family: Some(&fam), ..ComputedStyle::default() };
    let ts = text_style_from_cascade(&style);
...
fn extracts_all_properties_together() {
    let fs = CssValue::Dimension { value: 18.0, unit: CssUnit::Px };
    let lh = CssValue::Dimension { value: 24.0, unit: CssUnit::Px };
