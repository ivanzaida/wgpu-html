use crate::{CssProperty, CssValue};
...
pub fn longhands_of(property: CssProperty) -> &'static [CssProperty] {
  match property {
    CssProperty::Animation => &[
      ...
      CssProperty::AnimationTimeline,
      CssProperty::AnimationRange,
    ...
    CssProperty::BorderBlock => &[
      CssProperty::BorderBlockWidth,
      CssProperty::BorderBlockStyle,
      CssProperty::BorderBlockColor,
    ],
    CssProperty::BorderBlockEnd => &[
      CssProperty::BorderBlockEndWidth,
      CssProperty::BorderBlockEndStyle,
      CssProperty::BorderBlockEndColor,
    ],
    CssProperty::BorderBlockStart => &[
      CssProperty::BorderBlockStartWidth,
      CssProperty::BorderBlockStartStyle,
      CssProperty::BorderBlockStartColor,
    ],
    ...
    CssProperty::BorderInline => &[
      CssProperty::BorderInlineWidth,
      CssProperty::BorderInlineStyle,
      CssProperty::BorderInlineColor,
    ],
    CssProperty::BorderInlineEnd => &[
      CssProperty::BorderInlineEndWidth,
      CssProperty::BorderInlineEndStyle,
      CssProperty::BorderInlineEndColor,
    ],
    CssProperty::BorderInlineStart => &[
      CssProperty::BorderInlineStartWidth,
      CssProperty::BorderInlineStartStyle,
      CssProperty::BorderInlineStartColor,
    ],
    ...
    CssProperty::Mask => &[
      ...
      CssProperty::MaskClip,
      CssProperty::MaskOrigin,
      CssProperty::MaskComposite,
      CssProperty::MaskMode,
    ],
    CssProperty::Offset => &[
      CssProperty::OffsetPosition,
      CssProperty::OffsetPath,
      CssProperty::OffsetDistance,
      CssProperty::OffsetRotate,
      CssProperty::OffsetAnchor,
    ],
    CssProperty::Outline => &[
    ...
    CssProperty::ScrollMargin => &[
      CssProperty::ScrollMarginTop,
      CssProperty::ScrollMarginRight,
      CssProperty::ScrollMarginBottom,
      CssProperty::ScrollMarginLeft,
    ],
    ...
    CssProperty::ScrollPadding => &[
      CssProperty::ScrollPaddingTop,
      CssProperty::ScrollPaddingRight,
      CssProperty::ScrollPaddingBottom,
      CssProperty::ScrollPaddingLeft,
    ],
    ...
    CssProperty::ScrollPaddingInline => &[
      CssProperty::ScrollPaddingInlineStart,
      CssProperty::ScrollPaddingInlineEnd,
    ],
...
pub fn expand(property: CssProperty, values: &[CssValue]) -> Vec<(CssProperty, CssValue)> {
  match property {
    ...
    CssProperty::GridColumn => {
      return expand_grid_line_pair(values, CssProperty::GridColumnStart, CssProperty::GridColumnEnd);
    }
    CssProperty::GridRow => return expand_grid_line_pair(values, CssProperty::GridRowStart, CssProperty::GridRowEnd),
...
fn expand_grid_line_pair(values: &[CssValue], start: CssProperty, end: CssProperty) -> Vec<(CssProperty, CssValue)> {
  ...
  match values.len() {
    ...
    1 => {
      let end_val = if is_custom_ident(&values[0]) {
        values[0].clone()
      } else {
        auto_val()
      };
