use super::{base::EventInit, message::MessageEventInit};
...
impl Default for FetchEventInit {
  fn default() -> Self {
    Self {
...
pub struct ExtendableMessageEventInit {
  #[allow(dead_code)]
  pub extendable: ExtendableEventInit,
  pub message: MessageEventInit,
}
impl Default for ExtendableMessageEventInit {
  fn default() -> Self {
    Self {
      extendable: ExtendableEventInit::default(),
      message: MessageEventInit::default(),
    }
  }
}
...
#[derive(Debug, Clone)]
pub struct InstallEventInit {
  pub base: ExtendableEventInit,
}
impl Default for InstallEventInit {
  fn default() -> Self {
    Self {
      base: ExtendableEventInit::default(),
    }
...
impl Default for SyncEventInit {
  fn default() -> Self {
    Self {
      base: ExtendableEventInit::default(),
      tag: String::new(),
...
impl Default for PeriodicSyncEventInit {
  fn default() -> Self {
    Self {
      base: ExtendableEventInit::default(),
      tag: String::new(),
...
pub struct PushSubscriptionChangeEventInit {
  ...
  pub old_subscription: Option<String>,
}
impl Default for PushSubscriptionChangeEventInit {
  fn default() -> Self {
    Self {
      base: ExtendableEventInit::default(),
...
impl Default for NotificationEventInit {
  fn default() -> Self {
    Self {
      base: ExtendableEventInit::default(),
      notification: None,
...
impl Default for BackgroundFetchEventInit {
  fn default() -> Self {
    Self {
      base: ExtendableEventInit::default(),
      registration: None,
...
#[derive(Debug, Clone)]
pub struct BackgroundFetchUpdateUIEventInit {
  pub base: BackgroundFetchEventInit,
}
impl Default for BackgroundFetchUpdateUIEventInit {
  fn default() -> Self {
    Self {
      base: BackgroundFetchEventInit::default(),
    }
  }
}
...
impl Default for ContentIndexEventInit {
  fn default() -> Self {
    Self {
      base: ExtendableEventInit::default(),
      id: String::new(),
