...
impl Default for RTCDataChannelEventInit {
  fn default() -> Self {
    Self {
...
impl Default for RTCErrorEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      error: None,
...
impl Default for RTCPeerConnectionIceErrorEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      address: String::new(),
...
impl Default for RTCTrackEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      receiver: None,
...
#[derive(Debug, Clone)]
pub struct RTCTransformEventInit {
  pub base: EventInit,
  pub readable: Option<String>,
  pub writable: Option<String>,
}
impl Default for RTCTransformEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      readable: None,
