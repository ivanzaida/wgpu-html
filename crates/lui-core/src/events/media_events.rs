...
impl Default for MediaStreamTrackEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      track: None,
...
impl Default for MediaEncryptedEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      init_data_type: String::new(),
      init_data: None,
    }
  }
}
...
impl Default for MediaKeyMessageEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
...
pub struct PictureInPictureEventInit {
  pub base: EventInit,
  pub picture_in_picture_window: Option<String>,
}
impl Default for PictureInPictureEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      picture_in_picture_window: None,
    }
  }
}
...
impl Default for DocumentPictureInPictureEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      window: None,
...
impl Default for PortalActivateEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      data: None,
...
impl Default for PageRevealEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
    }
...
pub struct PageSwapEventInit {
  ...
  pub view_transition: Option<String>,
}
impl Default for PageSwapEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      activation: None,
...
impl Default for NavigateEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      navigation_type: String::new(),
      destination: None,
      can_intercept: false,
...
impl Default for NavigationCurrentEntryChangeEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      navigation_type: String::new(),
...
#[derive(Debug, Clone)]
pub struct BeforeUnloadEventInit {
  pub base: EventInit,
}
impl Default for BeforeUnloadEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
    }
...
#[derive(Debug, Clone)]
pub struct BeforeInstallPromptEventInit {
  pub base: EventInit,
  pub platforms: Vec<String>,
}
impl Default for BeforeInstallPromptEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      platforms: Vec::new(),
...
impl Default for PromiseRejectionEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      promise: None,
...
impl Default for TaskPriorityChangeEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      previous_priority: String::new(),
    }
  }
}
