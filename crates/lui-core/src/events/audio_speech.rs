...
impl Default for SpeechRecognitionErrorEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      error: String::new(),
...
impl Default for SpeechSynthesisEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      utterance: None,
...
pub struct SpeechSynthesisErrorEventInit {
  pub base: SpeechSynthesisEventInit,
  pub error: String,
}
impl Default for SpeechSynthesisErrorEventInit {
  fn default() -> Self {
    Self {
      base: SpeechSynthesisEventInit::default(),
      error: String::new(),
    }
  }
}
...
impl Default for AudioProcessingEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
      playback_time: 0.0,
...
pub struct OfflineAudioCompletionEventInit {
  pub base: EventInit,
  pub rendered_buffer: Option<String>,
}
impl Default for OfflineAudioCompletionEventInit {
  fn default() -> Self {
    Self {
      base: EventInit::default(),
