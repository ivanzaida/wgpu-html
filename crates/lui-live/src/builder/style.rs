...
//! chainable builder, then emitted as a `lui_core::Stylesheet`.
//!
//! # Example
//!
//! ```ignore
//! use lui_ui::style::{self, px, pct};
...
use lui_core::{ArcStr, CssProperty, CssValue, Declaration, ParseError, StyleRule, Stylesheet as CoreStylesheet};
use lui_parse::{complex_specificity, parse_declaration, parse_selector_list};
...
impl Stylesheet {
  ...
  /// Build a parsed core stylesheet using this stylesheet's configured scope.
  pub fn try_to_core_stylesheet(&self) -> Result<CoreStylesheet, ParseError> {
    if self.scope.is_empty() {
      self.try_to_core_stylesheet_unscoped()
    } else {
      self.try_to_core_stylesheet_scoped(self.scope)
    }
  }

  /// Build a parsed core stylesheet without applying any selector scope.
  pub fn try_to_core_stylesheet_unscoped(&self) -> Result<CoreStylesheet, ParseError> {
    let mut stylesheet = CoreStylesheet::default();
    for rule in &self.rules {
      if let Some(rule) = rule.to_core_rule(&rule.selector)? {
  ...
  /// Build a parsed core stylesheet with all class selectors prefixed.
  pub fn try_to_core_stylesheet_scoped(&self, prefix: &str) -> Result<CoreStylesheet, ParseError> {
    let mut stylesheet = CoreStylesheet::default();
    for rule in &self.rules {
      let selector = scope_selector(&rule.selector, prefix);
      if let Some(rule) = rule.to_core_rule(&selector)? {
        stylesheet.rules.push(rule);
      }
    }
    Ok(stylesheet)
...
impl Rule {
  fn to_core_rule(&self, selector: &str) -> Result<Option<StyleRule>, ParseError> {
    if self.decls.is_empty() {
      return Ok(None);
    }

    let selector = parse_selector_list(selector)?;
    let specificity = selector.0.iter().map(complex_specificity).max().unwrap_or((0, 0, 0));

    Ok(Some(StyleRule {
      selector,
      declarations: self.decls.iter().map(|decl| decl.declaration.clone()).collect(),
      specificity,
    }))
  }
  ...
  fn write_css(&self, out: &mut String) {
    ...
    for decl in &self.decls {
      let _ = write!(out, "    {}: {};\n", decl.raw_property, decl.raw_value);
    }
    out.push_str("}\n");
  }
  ...
  pub fn prop(mut self, property: impl Into<String>, value: impl Into<String>) -> Self {
    let raw_property = property.into();
    let raw_value = value.into();
    let (value, important) = split_important(&raw_value);
    let (property, value) = parse_declaration(&raw_property, value).unwrap_or_else(|_| {
      (
        CssProperty::from_name(&raw_property),
        CssValue::Unknown(ArcStr::from(value)),
      )
    });

    self.decls.push(DeclarationEntry {
      raw_property,
      raw_value,
      declaration: Declaration {
        property,
  ...
  pub fn display(self, v: impl Into<String>) -> Self {
    self.prop("display", v.into().to_string())
  }
  pub fn position(self, v: impl Into<String>) -> Self {
  ...
  pub fn flex_direction(self, v: impl Into<String>) -> Self {
    self.prop("flex-direction", v.into().to_string())
  }
  pub fn flex_wrap(self, v: impl Into<String>) -> Self {
  ...
  pub fn justify_content(self, v: impl Into<String>) -> Self {
    self.prop("justify-content", v.into().to_string())
  }
  pub fn align_items(self, v: impl Into<String>) -> Self {
    self.prop("align-items", v.into().to_string())
  }
  pub fn align_content(self, v: impl Into<String>) -> Self {
    self.prop("align-content", v.into().to_string())
  }
  pub fn align_self(self, v: impl Into<String>) -> Self {
  ...
  pub fn grid_auto_flow(self, v: impl Into<String>) -> Self {
  ...
  pub fn justify_items(self, v: impl Into<String>) -> Self {
    self.prop("justify-items", v.into().to_string())
  }
  pub fn justify_self(self, v: impl Into<String>) -> Self {
  ...
  pub fn font_weight(self, v: impl Into<String>) -> Self {
    self.prop("font-weight", v.into().to_string())
  }
  pub fn font_style(self, v: impl Into<String>) -> Self {
  ...
  pub fn text_align(self, v: impl Into<String>) -> Self {
    self.prop("text-align", v.into().to_string())
  }
  pub fn text_transform(self, v: impl Into<String>) -> Self {
  ...
  pub fn white_space(self, v: impl Into<String>) -> Self {
  ...
  pub fn background_clip(self, v: impl Into<String>) -> Self {
    self.prop("background-clip", v.into().to_string())
  }
  pub fn background_repeat(self, v: impl Into<String>) -> Self {
  ...
  pub fn border_style(self, v: impl Into<String>) -> Self {
  ...
  pub fn overflow(self, v: impl Into<String>) -> Self {
    self.prop("overflow", v.into().to_string())
  }
  pub fn overflow_x(self, v: impl Into<String>) -> Self {
    self.prop("overflow-x", v.into().to_string())
  }
  pub fn overflow_y(self, v: impl Into<String>) -> Self {
  ...
  pub fn box_sizing(self, v: impl Into<String>) -> Self {
    self.prop("box-sizing", v.into().to_string())
  }
  pub fn cursor(self, v: impl Into<String>) -> Self {
    self.prop("cursor", v.into().to_string())
  }
  pub fn pointer_events(self, v: impl Into<String>) -> Self {
    self.prop("pointer-events", v.into().to_string())
  }
  pub fn user_select(self, v: impl Into<String>) -> Self {
    self.prop("user-select", v.into().to_string())
  }
  pub fn visibility(self, v: impl Into<String>) -> Self {
...
fn split_important(value: &str) -> (&str, bool) {
  ...
  if let Some(value) = trimmed.strip_suffix("!important") {
    (value.trim_end(), true)
  } else {
    (trimmed, false)
  }
