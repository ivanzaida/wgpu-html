...
impl Rule {
  ...
  pub fn display(self, v: Display) -> Self {
    self.prop("display", css_display(v))
  }
  pub fn position(self, v: Position) -> Self {
    self.prop("position", css_position(v))
  }
  pub fn width(self, v: Val) -> Self {
    self.prop("width", v.to_css_string())
  }
  pub fn height(self, v: Val) -> Self {
    self.prop("height", v.to_css_string())
  }
  pub fn min_width(self, v: Val) -> Self {
    self.prop("min-width", v.to_css_string())
  }
  pub fn min_height(self, v: Val) -> Self {
    self.prop("min-height", v.to_css_string())
  }
  pub fn max_width(self, v: Val) -> Self {
    self.prop("max-width", v.to_css_string())
  }
  pub fn max_height(self, v: Val) -> Self {
    self.prop("max-height", v.to_css_string())
  }
  pub fn top(self, v: Val) -> Self {
    self.prop("top", v.to_css_string())
  }
  pub fn right(self, v: Val) -> Self {
    self.prop("right", v.to_css_string())
  }
  pub fn bottom(self, v: Val) -> Self {
    self.prop("bottom", v.to_css_string())
  }
  pub fn left(self, v: Val) -> Self {
    self.prop("left", v.to_css_string())
  }

  // ── Spacing ─────────────────────────────────────────────────────────

  pub fn margin(self, v: Val) -> Self {
    self.prop("margin", v.to_css_string())
  }
  pub fn margin_top(self, v: Val) -> Self {
    self.prop("margin-top", v.to_css_string())
  }
  pub fn margin_right(self, v: Val) -> Self {
    self.prop("margin-right", v.to_css_string())
  }
  pub fn margin_bottom(self, v: Val) -> Self {
    self.prop("margin-bottom", v.to_css_string())
  }
  pub fn margin_left(self, v: Val) -> Self {
    self.prop("margin-left", v.to_css_string())
  }
  pub fn padding(self, v: Val) -> Self {
    self.prop("padding", v.to_css_string())
  }
  pub fn padding_top(self, v: Val) -> Self {
    self.prop("padding-top", v.to_css_string())
  }
  pub fn padding_right(self, v: Val) -> Self {
    self.prop("padding-right", v.to_css_string())
  }
  pub fn padding_bottom(self, v: Val) -> Self {
    self.prop("padding-bottom", v.to_css_string())
  }
  pub fn padding_left(self, v: Val) -> Self {
    self.prop("padding-left", v.to_css_string())
  }
  ...
  pub fn flex_direction(self, v: FlexDirection) -> Self {
    self.prop("flex-direction", css_flex_direction(v))
  }
  pub fn flex_wrap(self, v: FlexWrap) -> Self {
    self.prop("flex-wrap", css_flex_wrap(v))
  }
  ...
  pub fn flex_basis(self, v: Val) -> Self {
    self.prop("flex-basis", v.to_css_string())
  }
  pub fn justify_content(self, v: JustifyContent) -> Self {
    self.prop("justify-content", css_justify_content(v))
  }
  pub fn align_items(self, v: AlignItems) -> Self {
    self.prop("align-items", css_align_items(v))
  }
  pub fn align_content(self, v: AlignContent) -> Self {
    self.prop("align-content", css_align_content(v))
  }
  pub fn align_self(self, v: AlignSelf) -> Self {
    self.prop("align-self", css_align_self(v))
  }
  pub fn gap(self, v: Val) -> Self {
    self.prop("gap", v.to_css_string())
  }
  pub fn row_gap(self, v: Val) -> Self {
    self.prop("row-gap", v.to_css_string())
  }
  pub fn column_gap(self, v: Val) -> Self {
    self.prop("column-gap", v.to_css_string())
  }
  ...
  pub fn grid_auto_flow(self, v: GridAutoFlow) -> Self {
    self.prop("grid-auto-flow", css_grid_auto_flow(v))
  }
  ...
  pub fn justify_items(self, v: JustifyItems) -> Self {
    self.prop("justify-items", css_justify_items(v))
  }
  pub fn justify_self(self, v: JustifySelf) -> Self {
    self.prop("justify-self", css_justify_self(v))
  }
  ...
  pub fn font_size(self, v: Val) -> Self {
    self.prop("font-size", v.to_css_string())
  }
  pub fn font_weight(self, v: FontWeight) -> Self {
    self.prop("font-weight", css_font_weight(v))
  }
  pub fn font_style(self, v: FontStyle) -> Self {
    self.prop("font-style", css_font_style(v))
  }
  pub fn line_height(self, v: Val) -> Self {
    self.prop("line-height", v.to_css_string())
  }
  pub fn letter_spacing(self, v: Val) -> Self {
    self.prop("letter-spacing", v.to_css_string())
  }
  pub fn text_align(self, v: TextAlign) -> Self {
    self.prop("text-align", css_text_align(v))
  }
  pub fn text_transform(self, v: TextTransform) -> Self {
    self.prop("text-transform", css_text_transform(v))
  }
  ...
  pub fn white_space(self, v: WhiteSpace) -> Self {
    self.prop("white-space", css_white_space(v))
  }
  ...
  pub fn background_clip(self, v: BackgroundClip) -> Self {
    self.prop("background-clip", css_background_clip(v))
  }
  pub fn background_repeat(self, v: BackgroundRepeat) -> Self {
    self.prop("background-repeat", css_background_repeat(v))
  }
  ...
  pub fn border_style(self, v: BorderStyle) -> Self {
    self.prop("border-style", css_border_style(v))
  }
  pub fn border_radius(self, v: Val) -> Self {
    self.prop("border-radius", v.to_css_string())
  }
  pub fn opacity(self, v: f32) -> Self {
    self.prop("opacity", v.to_string())
  }
  pub fn overflow(self, v: Overflow) -> Self {
    self.prop("overflow", css_overflow(v))
  }
  pub fn overflow_x(self, v: Overflow) -> Self {
    self.prop("overflow-x", css_overflow(v))
  }
  pub fn overflow_y(self, v: Overflow) -> Self {
    self.prop("overflow-y", css_overflow(v))
  }
  ...
  pub fn box_sizing(self, v: BoxSizing) -> Self {
    self.prop("box-sizing", css_box_sizing(v))
  }
  pub fn cursor(self, v: Cursor) -> Self {
    self.prop("cursor", css_cursor(v))
  }
  pub fn pointer_events(self, v: PointerEvents) -> Self {
    self.prop("pointer-events", css_pointer_events(v))
  }
  pub fn user_select(self, v: UserSelect) -> Self {
    self.prop("user-select", css_user_select(v))
  }
  pub fn visibility(self, v: Visibility) -> Self {
    self.prop("visibility", css_visibility(v))
  }
