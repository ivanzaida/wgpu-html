...
impl TreeHook for RecordingHook {
    fn on_render(&mut self, _tree: &mut Tree, event: &TreeRenderEvent<'_>) -> TreeHookResponse {
        ...
        assert_eq!(
            event.viewport,
            Some(TreeRenderViewport::new(800.0, 600.0, 1.5))
        );
    ...
    fn on_lifecycle_begin(
        &mut self,
        _tree: &mut Tree,
        event: &TreeLifecycleEvent<'_>,
    ) -> TreeHookResponse {
    ...
    fn on_dom_mouse_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::MouseEvent,
    ) -> TreeHookResponse {
        self.record("mouse")
    }
    ...
    fn on_pointer_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::PointerEvent,
    ) -> TreeHookResponse {
        self.record("pointer")
    }
    ...
    fn on_wheel_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::WheelEvent,
    ) -> TreeHookResponse {
        self.record("wheel")
    }
    ...
    fn on_keyboard_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::KeyboardEvent,
    ) -> TreeHookResponse {
    ...
    fn on_focus_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::FocusEvent,
    ) -> TreeHookResponse {
        self.record("focus")
    }
    ...
    fn on_input_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::InputEvent,
    ) -> TreeHookResponse {
        self.record("input")
    }

    fn on_composition_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::CompositionEvent,
    ) -> TreeHookResponse {
        self.record("composition")
    }

    fn on_clipboard_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::ClipboardEvent,
    ) -> TreeHookResponse {
    ...
    fn on_drag_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::DragEvent,
    ) -> TreeHookResponse {
        self.record("drag")
    }
    ...
    fn on_touch_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::TouchEvent,
    ) -> TreeHookResponse {
        self.record("touch")
    }
    ...
    fn on_animation_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::AnimationEvent,
    ) -> TreeHookResponse {
    ...
    fn on_transition_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::TransitionEvent,
    ) -> TreeHookResponse {
    ...
    fn on_submit_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::SubmitEvent,
    ) -> TreeHookResponse {
        self.record("submit")
    }

    fn on_form_data_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::FormDataEvent,
    ) -> TreeHookResponse {
    ...
    fn on_toggle_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::ToggleEvent,
    ) -> TreeHookResponse {
        self.record("toggle")
    }
    ...
    fn on_progress_event(
        &mut self,
        _tree: &mut Tree,
        _event: &mut dom::events::ProgressEvent,
    ) -> TreeHookResponse {
...
fn lifecycle_hook_fans_out_by_phase() {
    ...
    assert_eq!(
        log.entries(),
        ["lifecycle-begin", "lifecycle-end", "lifecycle-instant"]
    );
}
