...
pub trait TreeHook {
    ...
    fn on_keyboard_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::KeyboardEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
    ...
    fn on_composition_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::CompositionEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
    ...
    fn on_clipboard_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::ClipboardEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
    ...
    fn on_animation_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::AnimationEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
    ...
    fn on_transition_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::TransitionEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
    ...
    fn on_form_data_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::FormDataEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
    ...
    fn on_before_toggle_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::BeforeToggleEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
    ...
    fn on_progress_event(
        &mut self,
        tree: &mut Tree,
        event: &mut events::ProgressEvent,
    ) -> TreeHookResponse {
        TreeHookResponse::Continue
    }
