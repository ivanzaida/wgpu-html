...
pub enum CssProperty {
    ...
    /// longhands: [animation-name, animation-duration, animation-timing-function, animation-delay, animation-iteration-count, animation-direction, animation-fill-mode, animation-play-state, animation-timeline]
    ...
    /// longhands: [mask-border-source, mask-border-slice, mask-border-width, mask-border-outset, mask-border-repeat, mask-border-mode]
    /// legacy_alias_of: mask-border
    WebkitMaskBoxImage,
    ///
    ...
    /// legacy_alias_of: transform-origin
    ...
    /// initial: see individual properties
    /// longhands: [background-image, background-position, background-size, background-repeat, background-attachment, background-origin, background-clip, background-color]
    Background,
    ///
    ...
    /// initial: see individual properties
    /// longhands: [column-rule-inset-cap-start, column-rule-inset-cap-end, column-rule-inset-junction-start, column-rule-inset-junction-end]
    ColumnRuleInset,
    ///
    ...
    /// initial: none
    /// longhands: [grid-template-rows, grid-template-columns, grid-template-areas, grid-auto-rows, grid-auto-columns, grid-auto-flow]
    Grid,
    ///
    ...
    /// initial: 0px
    /// longhands: [overflow-clip-margin-top, overflow-clip-margin-right, overflow-clip-margin-bottom, overflow-clip-margin-left]
    OverflowClipMargin,
    ///
    ...
    /// syntax: <'column-rule-inset-cap'> [ / <'column-rule-inset-junction'> ]?
    /// initial: see individual properties
    /// longhands: [row-rule-inset-cap-start, row-rule-inset-cap-end, row-rule-inset-junction-start, row-rule-inset-junction-end]
    RowRuleInset,
    ///
    ...
    /// initial: See individual properties
    /// inherited: yes
    /// longhands: [text-decoration-skip-self, text-decoration-skip-box, text-decoration-skip-spaces, text-decoration-skip-ink]
    TextDecorationSkip,
    ///
    ...
    /// initial: see individual properties
    /// longhands: [timeline-trigger-name, timeline-trigger-source, timeline-trigger-activation-range, timeline-trigger-active-range]
    TimelineTrigger,
    ///
...
impl CssProperty {
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        const ENTRIES: &[(&str, CssProperty)] = &[
            ...
            ("-webkit-animation-iteration-count", CssProperty::WebkitAnimationIterationCount),
            ("-webkit-animation-name", CssProperty::WebkitAnimationName),
            ("-webkit-animation-play-state", CssProperty::WebkitAnimationPlayState),
            ("-webkit-animation-timing-function", CssProperty::WebkitAnimationTimingFunction),
            ...
            ("-webkit-border-bottom-left-radius", CssProperty::WebkitBorderBottomLeftRadius),
            ("-webkit-border-bottom-right-radius", CssProperty::WebkitBorderBottomRightRadius),
            ("-webkit-border-radius", CssProperty::WebkitBorderRadius),
            ("-webkit-border-top-left-radius", CssProperty::WebkitBorderTopLeftRadius),
            ("-webkit-border-top-right-radius", CssProperty::WebkitBorderTopRightRadius),
            ...
            ("-webkit-transition-timing-function", CssProperty::WebkitTransitionTimingFunction),
            ...
            ("column-rule-inset-junction-end", CssProperty::ColumnRuleInsetJunctionEnd),
            ("column-rule-inset-junction-start", CssProperty::ColumnRuleInsetJunctionStart),
            ...
            ("overflow-clip-margin-block-end", CssProperty::OverflowClipMarginBlockEnd),
            ("overflow-clip-margin-block-start", CssProperty::OverflowClipMarginBlockStart),
            ...
            ("overflow-clip-margin-inline-end", CssProperty::OverflowClipMarginInlineEnd),
            ("overflow-clip-margin-inline-start", CssProperty::OverflowClipMarginInlineStart),
            ...
            ("stroke-dash-corner", CssProperty::StrokeDashCornerPropdefStrokeDashCorner),
            ...
            ("stroke-dashcorner", CssProperty::StrokeDashcornerStrokedashcornerproperty),
            ...
            ("timeline-trigger-activation-range", CssProperty::TimelineTriggerActivationRange),
            ("timeline-trigger-activation-range-end", CssProperty::TimelineTriggerActivationRangeEnd),
            ("timeline-trigger-activation-range-start", CssProperty::TimelineTriggerActivationRangeStart),
            ("timeline-trigger-active-range", CssProperty::TimelineTriggerActiveRange),
            ("timeline-trigger-active-range-end", CssProperty::TimelineTriggerActiveRangeEnd),
            ("timeline-trigger-active-range-start", CssProperty::TimelineTriggerActiveRangeStart),
    ...
    pub fn syntax(self) -> &'static str {
        match self {
            ...
            CssProperty::WebkitAlignSelf => "auto | <overflow-position>? [ normal | <self-position> ]| stretch | <baseline-position>",
            ...
            CssProperty::WebkitJustifyContent => "normal | <content-distribution> | <overflow-position>? [ <content-position> | left | right ]",
            CssProperty::WebkitLineClamp => "none | <integer [1,∞]>",
            CssProperty::WebkitMask => "<mask-layer>#",
            CssProperty::WebkitMaskBoxImage => "<'mask-border-source'> || <'mask-border-slice'> [ / <'mask-border-width'>? [ / <'mask-border-outset'> ]? ]? || <'mask-border-repeat'> || <'mask-border-mode'>",
            ...
            CssProperty::WebkitTransformOrigin => "[ left | center | right | top | bottom | <length-percentage> ] | [ left | center | right | <length-percentage> ] [ top | center | bottom | <length-percentage> ] <length>? | [ [ center | left | right ] && [ center | top | bottom ] ] <length>?",
            ...
            CssProperty::AlignContent => "normal | <baseline-position> | <content-distribution> | <overflow-position>? <content-position>",
            CssProperty::AlignItems => "normal | stretch | <baseline-position> | <overflow-position>? <self-position>",
            CssProperty::AlignSelf => "auto | <overflow-position>? [ normal | <self-position> ]| stretch | <baseline-position> | anchor-center",
            ...
            CssProperty::AnimationRangeCenter => "[ normal | [ <length-percentage> | <timeline-range-center-subject> <length-percentage>? ] ]#",
            CssProperty::AnimationRangeEnd => "[ normal | <length-percentage> | <timeline-range-name> <length-percentage>? ]#",
            CssProperty::AnimationRangeStart => "[ normal | <length-percentage> | <timeline-range-name> <length-percentage>? ]#",
            ...
            CssProperty::BlockStep => "<'block-step-size'> || <'block-step-insert'> || <'block-step-align'> || <'block-step-round'>",
            ...
            CssProperty::BorderImage => "<'border-image-source'> || <'border-image-slice'> [ / <'border-image-width'> | / <'border-image-width'>? / <'border-image-outset'> ]? || <'border-image-repeat'>",
            ...
            CssProperty::BorderLimit => "all | [ sides | corners ] <length-percentage [0,∞]>? | [ top | right | bottom | left ] <length-percentage [0,∞]>",
            ...
            CssProperty::BreakAfter => "auto | avoid | always | all | avoid-page | page | left | right | recto | verso | avoid-column | column | avoid-region | region",
            CssProperty::BreakBefore => "auto | avoid | always | all | avoid-page | page | left | right | recto | verso | avoid-column | column | avoid-region | region",
            ...
            CssProperty::Clear => "inline-start | inline-end | block-start | block-end | left | right | top | bottom | both-inline | both-block | both | none",
            ...
            CssProperty::ColumnWidth => "auto | <length [0,∞]> | min-content | max-content | fit-content(<length-percentage>)",
            ...
            CssProperty::Content => "normal | none | [ <content-replacement> | <content-list> ] [/ [ <string> | <counter> | <attr()> ]+ ]? | <element()>",
            ...
            CssProperty::Display => "[ <display-outside> || <display-inside> ] | <display-listitem> | <display-internal> | <display-box> | <display-legacy> | grid-lanes | inline-grid-lanes | <display-outside> || [ <display-inside> | math ]",
            ...
            CssProperty::Float => "block-start | block-end | inline-start | inline-end | snap-block | <snap-block()> | snap-inline | <snap-inline()> | left | right | top | bottom | none | footnote",
            ...
            CssProperty::Font => "[ [ <'font-style'> || <font-variant-css2> || <'font-weight'> || <font-width-css3> ]? <'font-size'> [ / <'line-height'> ]? <'font-family'># ] | <system-font-family-name>",
            ...
            CssProperty::FontSizeAdjust => "none | [ ex-height | cap-height | ch-width | ic-width | ic-height ]? [ from-font | <number [0,∞]> ]",
            CssProperty::FontStretch => "normal | <percentage [0,∞]> | ultra-condensed | extra-condensed | condensed | semi-condensed | semi-expanded | expanded | extra-expanded | ultra-expanded",
            ...
            CssProperty::FontVariant => "normal | none | [ [ <common-lig-values> || <discretionary-lig-values> || <historical-lig-values> || <contextual-alt-values> ] || [ small-caps | all-small-caps | petite-caps | all-petite-caps | unicase | titling-caps ] || [ stylistic(<font-feature-value-name>) || historical-forms || styleset(<font-feature-value-name>#) || character-variant(<font-feature-value-name>#) || swash(<font-feature-value-name>) || ornaments(<font-feature-value-name>) || annotation(<font-feature-value-name>) ] || [ <numeric-figure-values> || <numeric-spacing-values> || <numeric-fraction-values> || ordinal || slashed-zero ] || [ <east-asian-variant-values> || <east-asian-width-values> || ruby ] || [ sub | super ] || [ text | emoji | unicode ] ]",
            CssProperty::FontVariantAlternates => "normal | [ stylistic(<font-feature-value-name>) || historical-forms || styleset(<font-feature-value-name>#) || character-variant(<font-feature-value-name>#) || swash(<font-feature-value-name>) || ornaments(<font-feature-value-name>) || annotation(<font-feature-value-name>) ]",
            CssProperty::FontVariantCaps => "normal | small-caps | all-small-caps | petite-caps | all-petite-caps | unicase | titling-caps",
            CssProperty::FontVariantEastAsian => "normal | [ <east-asian-variant-values> || <east-asian-width-values> || ruby ]",
            CssProperty::FontVariantEmoji => "normal | text | emoji | unicode",
            CssProperty::FontVariantLigatures => "normal | none | [ <common-lig-values> || <discretionary-lig-values> || <historical-lig-values> || <contextual-alt-values> ]",
            CssProperty::FontVariantNumeric => "normal | [ <numeric-figure-values> || <numeric-spacing-values> || <numeric-fraction-values> || ordinal || slashed-zero ]",
            ...
            CssProperty::FontWidth => "normal | <percentage [0,∞]> | ultra-condensed | extra-condensed | condensed | semi-condensed | semi-expanded | expanded | extra-expanded | ultra-expanded",
            ...
            CssProperty::Grid => "<'grid-template'> | <'grid-template-rows'> / [ auto-flow && dense? ] <'grid-auto-columns'>? | [ auto-flow && dense? ] <'grid-auto-rows'>? / <'grid-template-columns'>",
            ...
            CssProperty::GridTemplate => "none | [ <'grid-template-rows'> / <'grid-template-columns'> ] | [ <line-names>? <string> <track-size>? <line-names>? ]+ [ / <explicit-track-list> ]?",
            ...
            CssProperty::Height => "auto | <length-percentage [0,∞]> | min-content | max-content | fit-content(<length-percentage [0,∞]>) | <calc-size()> | <anchor-size()> | stretch | fit-content | contain",
            ...
            CssProperty::JustifyContent => "normal | <content-distribution> | <overflow-position>? [ <content-position> | left | right ]",
            CssProperty::JustifyItems => "normal | stretch | <baseline-position> | <overflow-position>? [ <self-position> | left | right ] | legacy | legacy && [ left | right | center ]",
            CssProperty::JustifySelf => "auto | <overflow-position>? [ normal | <self-position> | left | right ] | stretch | <baseline-position> | anchor-center",
            ...
            CssProperty::MarginTrim => "none | [ block || inline ] | [ block-start || inline-start || block-end || inline-end ]",
            ...
            CssProperty::MaskBorder => "<'mask-border-source'> || <'mask-border-slice'> [ / <'mask-border-width'>? [ / <'mask-border-outset'> ]? ]? || <'mask-border-repeat'> || <'mask-border-mode'>",
            ...
            CssProperty::MaxHeight => "none | <length-percentage [0,∞]> | min-content | max-content | fit-content(<length-percentage [0,∞]>) | <calc-size()> | <anchor-size()> | stretch | fit-content | contain",
            CssProperty::MaxInlineSize => "<'max-width'>",
            CssProperty::MaxLines => "none | <integer [1,∞]>",
            CssProperty::MaxWidth => "none | <length-percentage [0,∞]> | min-content | max-content | fit-content(<length-percentage [0,∞]>) | <calc-size()> | <anchor-size()> | stretch | fit-content | contain",
            CssProperty::MinBlockSize => "<'min-width'>",
            CssProperty::MinHeight => "auto | <length-percentage [0,∞]> | min-content | max-content | fit-content(<length-percentage [0,∞]>) | <calc-size()> | <anchor-size()> | stretch | fit-content | contain",
            CssProperty::MinInlineSize => "<'min-width'>",
            CssProperty::MinIntrinsicSizing => "legacy | zero-if-scroll || zero-if-extrinsic",
            CssProperty::MinWidth => "auto | <length-percentage [0,∞]> | min-content | max-content | fit-content(<length-percentage [0,∞]>) | <calc-size()> | <anchor-size()> | stretch | fit-content | contain",
            ...
            CssProperty::Offset => "[ <'offset-position'>? [ <'offset-path'> [ <'offset-distance'> || <'offset-rotate'> ]? ]? ]! [ / <'offset-anchor'> ]?",
            ...
            CssProperty::PointerEvents => "auto | bounding-box | visiblePainted | visibleFill | visibleStroke | visible | painted | fill | stroke | all | none",
            ...
            CssProperty::ReadingFlow => "normal | source-order | flex-visual | flex-flow | grid-rows | grid-columns | grid-order",
            ...
            CssProperty::TextDecoration => "<'text-decoration-line'> || <'text-decoration-thickness'> || <'text-decoration-style'> || <'text-decoration-color'>",
            CssProperty::TextDecorationColor => "<color>",
            CssProperty::TextDecorationInset => "<length>{1,2} | auto",
            CssProperty::TextDecorationLine => "none | [ underline || overline || line-through || blink ] | spelling-error | grammar-error",
            ...
            CssProperty::TextDecorationSkipSelf => "auto | skip-all | [ skip-underline || skip-overline || skip-line-through ] | no-skip",
            ...
            CssProperty::TextEmphasisStyle => "none | [ [ filled | open ] || [ dot | circle | double-circle | triangle | sesame ] ] | <string>",
            ...
            CssProperty::TextTransform => "none | [capitalize | uppercase | lowercase ] || full-width || full-size-kana | math-auto",
            ...
            CssProperty::TimelineTrigger => "none | [ <'timeline-trigger-name'> <'timeline-trigger-source'> <'timeline-trigger-activation-range'> [ '/' <'timeline-trigger-active-range'> ]? ]#",
            CssProperty::TimelineTriggerActivationRange => "[ <'timeline-trigger-activation-range-start'> <'timeline-trigger-activation-range-end'>? ]#",
            CssProperty::TimelineTriggerActivationRangeEnd => "[ normal | <length-percentage> | <timeline-range-name> <length-percentage>? ]#",
            CssProperty::TimelineTriggerActivationRangeStart => "[ normal | <length-percentage> | <timeline-range-name> <length-percentage>? ]#",
            CssProperty::TimelineTriggerActiveRange => "[ <'timeline-trigger-active-range-start'> <'timeline-trigger-active-range-end'>? ]#",
            CssProperty::TimelineTriggerActiveRangeEnd => "[ auto | normal | <length-percentage> | <timeline-range-name> <length-percentage>? ]#",
            CssProperty::TimelineTriggerActiveRangeStart => "[ auto | normal | <length-percentage> | <timeline-range-name> <length-percentage>? ]#",
            ...
            CssProperty::TouchAction => "auto | none | [ [ pan-x | pan-left | pan-right ] || [ pan-y | pan-up | pan-down ] || pinch-zoom ] | manipulation",
            CssProperty::Transform => "none | <transform-list>",
            CssProperty::TransformBox => "content-box | border-box | fill-box | stroke-box | view-box",
            CssProperty::TransformOrigin => "[ left | center | right | top | bottom | <length-percentage> ] | [ left | center | right | <length-percentage> ] [ top | center | bottom | <length-percentage> ] <length>? | [ [ center | left | right ] && [ center | top | bottom ] ] <length>?",
            ...
            CssProperty::VoicePitch => "<frequency [0Hz,∞]> && absolute | [ [ x-low | low | medium | high | x-high ] || [ <frequency [0Hz,∞]> | <semitones> | <percentage> ] ]",
            CssProperty::VoiceRange => "<frequency [0Hz,∞]> && absolute | [ [ x-low | low | medium | high | x-high ] || [ <frequency [0Hz,∞]> | <semitones> | <percentage> ] ]",
            ...
            CssProperty::WhiteSpace => "normal | pre | pre-wrap | pre-line | <'white-space-collapse'> || <'text-wrap-mode'> || <'white-space-trim'>",
            CssProperty::WhiteSpaceCollapse => "collapse | discard | preserve | preserve-breaks | preserve-spaces | break-spaces",
            CssProperty::WhiteSpaceTrim => "none | discard-before || discard-after || discard-inner",
            CssProperty::Widows => "<integer [1,∞]>",
            CssProperty::Width => "auto | <length-percentage [0,∞]> | min-content | max-content | fit-content(<length-percentage [0,∞]>) | <calc-size()> | <anchor-size()> | stretch | fit-content | contain",
