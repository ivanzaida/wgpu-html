        ...
        WindowEvent::MouseWheel { delta, .. } => {
            ...
            let prevented = match delta {
                MouseScrollDelta::LineDelta(x, y) => {
                    rt.on_wheel_event(tree, 0.0, 0.0, *x as f64, *y as f64, wgpu_html::events::WheelDeltaMode::Line)
                }
                MouseScrollDelta::PixelDelta(phys_pos) => {
                    rt.on_wheel_event(
                        ...
                        0.0,
                        0.0,
                        phys_pos.x as f64 / scale as f64,
                        phys_pos.y as f64 / scale as f64,
