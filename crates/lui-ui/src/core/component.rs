...
///
/// ```ignore
/// use lui_ui::{Component, Ctx, ShouldRender, el, El, Observable, Subscriptions, MsgSender};
///
/// struct Counter {
///     count: i32,
...
///     }
///
///     fn styles() -> lui_ui::style::Stylesheet {
///         lui_ui::style::sheet([
///             lui_ui::style::rule(".root")
///                 .display(lui_models::common::Display::Flex)
///                 .gap(lui_ui::style::px(8)),
///         ]).scoped("counter")
///     }
/// }
/// ```
