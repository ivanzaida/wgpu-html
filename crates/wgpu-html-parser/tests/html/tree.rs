...
fn div_has_id_class() {
    ...
    let Element::Div(div) = &r.element else { panic!("expected Div") };
...
fn p_has_inline_style_string() {
    ...
    let Element::P(p) = &r.element else { panic!("expected P") };
...
fn anchor_href() {
    ...
    let Element::A(a) = &r.element else { panic!("expected A") };
...
fn img_src_alt() {
    ...
    let Element::Img(img) = &r.element else { panic!("expected Img") };
...
fn input_type_value() {
    ...
    let Element::Input(inp) = &r.element else { panic!("expected Input") };
...
fn multiple_data_attrs_are_all_preserved() {
    ...
    let Element::Div(d) = &r.element else { panic!("expected div") };
...
fn multiple_aria_attrs_are_all_preserved() {
    ...
    let Element::Button(b) = &r.element else { panic!("expected button") };
