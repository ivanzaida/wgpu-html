...
pub fn shorthand_contains_member(shorthand: &str, member: &str) -> bool {
  ...
  members
    .iter()
    .any(|candidate| *candidate == member || (*candidate != shorthand && shorthand_contains_member(candidate, member)))
}
...
const BORDER_BLOCK: [&str; 3] = ["border-block-width", "border-block-style", "border-block-color"];
...
const BORDER_BOTTOM: [&str; 3] = ["border-bottom-width", "border-bottom-style", "border-bottom-color"];
...
const BORDER_INLINE: [&str; 3] = ["border-inline-width", "border-inline-style", "border-inline-color"];
...
const COLUMN_RULE: [&str; 3] = ["column-rule-width", "column-rule-style", "column-rule-color"];
...
const GRID_AREA: [&str; 4] = ["grid-row-start", "grid-column-start", "grid-row-end", "grid-column-end"];
...
const GRID_TEMPLATE: [&str; 3] = ["grid-template-rows", "grid-template-columns", "grid-template-areas"];
...
const OVERSCROLL_BEHAVIOR_BLOCK: [&str; 2] = ["overscroll-behavior-block-start", "overscroll-behavior-block-end"];
const OVERSCROLL_BEHAVIOR_INLINE: [&str; 2] = ["overscroll-behavior-inline-start", "overscroll-behavior-inline-end"];
...
const SCROLL_PADDING_INLINE: [&str; 2] = ["scroll-padding-inline-start", "scroll-padding-inline-end"];
...
const VIEW_TIMELINE: [&str; 3] = ["view-timeline-name", "view-timeline-axis", "view-timeline-inset"];
