...
pub fn paint_borders(
  ...
  let all_solid = matches!(
    (top_style, right_style, bottom_style, left_style),
...
fn paint_edge(
  ...
  let rect = match edge {
    ...
    Edge::Right => DlRect::new(
      border_rect.x + border_rect.w - thickness,
      border_rect.y,
      thickness,
      border_rect.h,
    ),
    Edge::Bottom => DlRect::new(
      border_rect.x,
      border_rect.y + border_rect.h - thickness,
      border_rect.w,
      thickness,
    ),
