//! Full DOM event hierarchy for `lui`.
//!
//! # Architecture
//!
...
//!
//! ```
//! # use lui_events::events::MouseEvent;
...
//! # Modules
//!
//! - [`enums`] — `EventPhase`, `PointerType`, `WheelDeltaMode`, `KeyboardLocation`, `ToggleState`, `InputType`.
...
///
/// The host assigns and manages these IDs; `lui-events` never looks
/// inside.
